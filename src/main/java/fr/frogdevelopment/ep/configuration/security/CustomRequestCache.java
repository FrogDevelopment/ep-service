...
public class CustomRequestCache extends HttpSessionRequestCache {
    ...
    /**
     * Unfortunately, it's not that easy to resolve the redirect URL from the saved request. But with some casting (we
     * always use {@link DefaultSavedRequest}) and mangling we are able to get the request URI.
     */
